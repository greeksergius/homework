...
> Кластер построен на двух физических серверах в режиме репликации MASTER - SLAVE - SLAVE. Согласно трем заданным таблицам решил разбить по методу вертикального расширения на отдельную ВМ таблицу Books, т.к. предпологаю, что там возможно будет большой размер таблицы (объем данных), в дальйншем и увеличение  полей (хотя я бы ее и не разбивал в принципе, но в задании указано и про вертикальное расширение), что повлечет за собой сложные SELECTы и большие выборки данных (например в массивы). SLAVE сервера, как раз для разграничения нагрузки будут отвечать за SELECT из различных SLAVEов, а на местере выполняться INSERT, UPDATE и тд запросы.


[Диаграмма в полном размере](https://github.com/greeksergius/homework/blob/main/12-7-sql-rep-2/%D0%94%D0%B8%D0%B0%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B0%20%D0%B1%D0%B5%D0%B7%20%D0%BD%D0%B0%D0%B7%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F.drawio.png)

![Alt-текст](https://github.com/greeksergius/homework/blob/main/12-7-sql-rep-2/%D0%94%D0%B8%D0%B0%D0%B3%D1%80%D0%B0%D0%BC%D0%BC%D0%B0%20%D0%B1%D0%B5%D0%B7%20%D0%BD%D0%B0%D0%B7%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F.jpg)
